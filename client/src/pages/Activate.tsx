                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-muted-foreground">
                      Connectez-vous en un instant avec votre biométrie. Simple, rapide et très
                      sécurisé.
                    </p>
                  </div>
                </div>
          ...
          {step === 'passkey-setup' && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Votre appareil va vous demander de confirmer votre identité (empreinte digitale,
                  Face ID, Windows Hello…). Suivez les instructions à l'écran.
                </p>
              </div>
          ...
          {step === 'mfa' && (
            <form onSubmit={handleMfaSubmit} className="space-y-6">
              ...
              <div className="text-center">
                ...
                <code className="rounded bg-muted px-3 py-1 font-mono text-sm text-foreground">
                  {mfaSecret}
                </code>
              </div>
