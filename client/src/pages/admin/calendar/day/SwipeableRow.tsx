    ...
    <div ref={containerRef} className="relative">
      ...
      {left && (
        <motion.div
          ...
          className={cn(
            'absolute inset-y-1 left-1 flex items-center justify-start gap-2 overflow-hidden whitespace-nowrap pl-3 shadow-inner',
            radiusClassName,
            left.className
          )}
        >
      ...
      {right && (
        <motion.div
          ...
          className={cn(
            'absolute inset-y-1 right-1 flex items-center justify-end gap-2 overflow-hidden whitespace-nowrap pr-3 shadow-inner',
            radiusClassName,
            right.className
          )}
        >
