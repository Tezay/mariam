...
export function WeekCategoryBox({
  ...
  const renderAddControl = (catId: number) =>
    canEdit ? (
      <div className={cn(!showAdd && 'pointer-events-none invisible')} aria-hidden={!showAdd}>
      ...
      <div className="flex items-center gap-2 px-1">
        ...
        {selectionMode ? (
          <button
            ...
            className="flex items-center gap-1.5 whitespace-nowrap rounded-lg px-1 py-0.5 text-[10px] font-bold uppercase tracking-widest transition-colors hover:bg-muted"
