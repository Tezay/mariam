  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Sélectionnez les jours d'ouverture et les horaires associés
        </CardDescription>
      </CardHeader>
          ...
          <div className="space-y-4 border-t border-border pt-2">
            <label className="flex cursor-pointer select-none items-center gap-2">
              <input
                ...
                onChange={(e) => {
                  ...
                  if (e.target.checked) {
                    const first = Object.values(serviceHours)[0] ?? {
                      open: '11:30',
                      close: '14:00',
                    };
                    const unified: ServiceHours = {};
                    serviceDays.forEach((d) => {
                      unified[String(d)] = { ...first };
                    });
            ...
            {sameHoursForAll ? (
              <div className="flex items-center gap-4">
                <div>
                  <Label className="mb-1 block text-xs text-muted-foreground">Ouverture</Label>
                  <Input
                    type="time"
                    className="w-32"
                    ...
                    onChange={(e) => {
                      ...
                      setServiceHours((prev) => {
                        ...
                        serviceDays.forEach((d) => {
                          next[String(d)] = {
                            open: val,
                            close: prev[String(d)]?.close ?? '14:00',
                          };
                        });
                        return next;
                      });
                ...
                <div>
                  <Label className="mb-1 block text-xs text-muted-foreground">Fermeture</Label>
                  <Input
                    type="time"
                    className="w-32"
