        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Menu du jour</p>
                    <label className="flex items-start gap-3 cursor-pointer group">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-foreground">Alerter si le menu n'est pas publié</p>
                            <p className="text-xs text-muted-foreground">Visible dans la cloche dès l'ouverture de l'interface.</p>
                        </div>
                    </label>
                    <label className="flex items-start gap-3 cursor-pointer">
                        ...
                        />
                        <div>
                            <p className="text-sm font-medium text-foreground">Alerte urgente pendant les heures de service</p>
                            <p className="text-xs text-muted-foreground">Signale en rouge si le service est en cours et le menu non publié.</p>
                        </div>
                    </label>
                </div>
                ...
                <div className="space-y-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Jours fériés</p>
                    <label className="flex items-start gap-3 cursor-pointer">
                        <input
                            type="checkbox"
                        ...
                        />
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-foreground">Alerter si un jour férié approche</p>
                        </div>
                        <div className="flex items-center gap-2 shrink-0">
                            <input
                                ...
                                onChange={e => update({ holiday_alert_days_before: Math.max(1, Math.min(30, parseInt(e.target.value) || 5)) })}
                                disabled={!prefs.notify_holiday_approaching}
                                className="w-16 rounded-lg border border-border bg-background px-2 py-1 text-sm text-center focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-40"
                            />
                            <span className="text-xs text-muted-foreground whitespace-nowrap">jours avant</span>
                        </div>
                    </label>
                </div>
            </CardContent>
