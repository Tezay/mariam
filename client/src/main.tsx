...
// A retired host must not register a service worker it is about to leave.
if (canonicalTarget(window.location.host, window.__RUNTIME_CONFIG__?.CANONICAL_HOST)) {
  void migrateToCanonicalHost();
} else {
  bootstrap();
}
