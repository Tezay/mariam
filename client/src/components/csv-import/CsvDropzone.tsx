...
export function CsvDropzone({ accept, hint, onFile }: CsvDropzoneProps) {
  ...
  return (
    <div
      className="flex cursor-pointer flex-col items-center gap-3 rounded-2xl border-2 border-dashed border-border p-8 transition-colors hover:border-primary/50 hover:bg-primary/5"
